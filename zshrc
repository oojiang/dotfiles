...
# fix reverse-search not working in tmux
...
set -o emacs # Don't make vim-mode default in tmux
...
__conda_setup="$('/Users/ogelsir/opt/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
...
export SUMO_HOME="/usr/local/bin/sumo"
