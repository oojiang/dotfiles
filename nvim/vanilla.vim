...
"" Appearance {{{
    ...
    set fillchars+=stl:=
    set fillchars+=stlnc:=
    set scrolloff=3 " set 3 lines to the cursors - when moving vertical
...
"" Custom Mappings {{{
    ...
    function! Line_wrap_on()
      set wrap
      set linebreak
      noremap <silent> \ww :call Line_wrap_off()<cr>
      call Wrap_mode_on()
      echo 'Line wrap on!'
    endfunction
    function! Line_wrap_off()
      set nowrap
      set nolinebreak
      noremap <silent> \ww :call Line_wrap_on()<cr>
      call Wrap_mode_off()
      echo 'Line wrap off!'
    endfunction
    noremap <silent> \ww :call Line_wrap_on()<cr>
    ...
    nnoremap \wv :call Wrap_mode_on()<cr>
    function! Wrap_mode_on()
        ...
        noremap <silent> $ g$
        noremap <silent> 0 g0
        noremap \wv :call Wrap_mode_off()<cr>
    endfunction
    function! Wrap_mode_off()
        ...
        noremap <silent> $ $
        noremap <silent> 0 0
        noremap \wv :call Wrap_mode_on()<cr>
    endfunction
